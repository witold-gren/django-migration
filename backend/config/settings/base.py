"""
Base settings for Build migration project.
...
# (build_migration/backend/config/settings/base.py - 3 = build_migration/backend) or inside docker container is path /app
...
# MIGRATIONS
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {"sites": "build_migration.contrib.sites.migrations"}
...
ADMINS = [("""Witold Gren""", "witold.gren@plentific.com")]
