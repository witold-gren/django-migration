...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            "--username", action="store", dest="username", help="Username for new user"
        )
        parser.add_argument(
            "--email", action="store", dest="email", help="Email for new user"
        )
        parser.add_argument(
            "--password", action="store", dest="password", help="Password for new user"
        )
